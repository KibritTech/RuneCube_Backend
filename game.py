...
class Player:
    def __init__(self, player_sid, player_username, player_role):
...
class Game:
    def __init__(self,game_id, start_time, spend_time, finish_time, game_finished=False):
    ...
    def add_player(self, player_sid, player_username, player_role):
        self.players.append(Player(player_sid, player_username, player_role))
